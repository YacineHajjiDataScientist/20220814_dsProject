...
# 
# - **Import**: Import des modules et des données, splitting en train/test sets, scalling des données, transformation des features pour le XGBoost, import des modèles  
# - **SHAP**: Initialisation et affichage des graphiques SHAP, des graphiques de feature importance du XGBoost    
# - **User case**: User case complet avec les différentes étapes (sans le LGBM)  
#     * a) Prédictions avec le XGBoost (pour afficher la distribution des probabilités pour le user-case)
#     * b) Description du user-case
#     * c) Trouver les cutoffs optimums pour chaque modèle en fonction de la problématique (transports/économie/expert analyste)
#     * d) Affichage des performances du XGBoost (positive recall, positive precision, sum of positive and negative recalls) en fonction de son cutoff/seuil
#     * e) Comparaison des modèles aux seuils d'intérêt et affichage sur les ROC curves des seuils concernés pour chaque modèle
# 
# 
# Il y a une fonction de Youden dans le notebook.  
# 
# Il y a quelques explorations qui n'ont pas marché dans ce notebook (affichage de certains graphiques SHAP/SAGE). J'ai aussi à la fin essayé de faire tourner le LGBM pour obtenir les prédictions mais ça n'a pas fonctionné. Enfin, j'ai affiché les probabilités prédites par l'Elastic Net à la toute fin.  
...
# #### Initiating SHAP objects for each model
...
# <span style="color:red">Exploration pour afficher des graphiques SHAP différents, qui a échoué---</span>
...
# <span style="color:red">---fin exploration</span>
...
# <span style="color:red">Exploration: tentative affichage graphiques SAGE---</span>
...
# ### Predictions with XGBoost (nécessaires au User case)
...
# <span style="color:red">Exploration: Affichage des résultats à des cutoffs sélectionnés: problème, on ne peut pas comparer plusieurs modèles entre eux car pas calibrés---</span>
...
# <span style="color:red">Exploration: Tentative d'avoir le dataframe contenant les performances du LGBM pour chaque cutoff, il y a eu un problème au niveau des données---</span>
...
# <span style="color:red">Exploration: Affichage de la distribution des probabilités prédites de l'Elastic Net---</span>
